...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { end_date: @sprint.end_date, name: @sprint.name, start_date: @sprint.start_date, xid: @sprint.xid }
    end
  ...
  test "should update sprint" do
    put :update, id: @sprint, sprint: { end_date: @sprint.end_date, name: @sprint.name, start_date: @sprint.start_date, xid: @sprint.xid }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
